 ...
 */
  ...
  const playerLaserIntervalTime = 100 * 1
  ...
  let alienLaserRandomIntervalTime = 100 * Math.floor(Math.random() * 9)
  ...
  let playerShipCurrentPosition = 390 

  const alienShipsStartPosition = [66,67,68,69,70,71,72,73,85,86,87,88,89,90,91,92,93,94]
  let alienShipsCurrentPosition = [66,67,68,69,70,71,72,73,85,86,87,88,89,90,91,92,93,94]
